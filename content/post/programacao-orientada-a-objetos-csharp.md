...
+++
## Programação orientada orientada a objetos
...
- **Abstração**: Reduzir a exposição dos objetos, escondendo os detalhes da implementação e expondo só o que é necessário.
...
Para garantir a obrigatoriedade de que o objeto receba dados / dependências no momento de sua instanciação devemos utilizar o construtor.
