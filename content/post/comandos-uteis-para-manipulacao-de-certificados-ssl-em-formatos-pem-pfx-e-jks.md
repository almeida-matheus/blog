...
A ferramenta `openssl` é utilizada para manipular certificados PEM e PFX (PKCS12), já a ferramenta `keytool` é utilizada para manipular certificados JKS.
...
Este artigo foi originalmente publicado no [Medium](https://almeida-matheus.medium.com/comandos-%C3%BAteis-para-manipula%C3%A7%C3%A3o-de-certificados-ssl-em-formatos-pem-pfx-e-jks-8f5b517bcbf3).